          ...
          <div className="max-w-7xl mx-auto mb-20">
            <div className="text-center mb-12">
              ...
              {landing.howItWorksSubtitle ? (
                <p className="text-lg text-[#666666] max-w-2xl mx-auto">{landing.howItWorksSubtitle}</p>
              ) : null}
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
              {steps.map((step, index) => {
                ...
                return (
                  <div
                    key={step.title}
                    className="bg-white rounded-2xl border border-neutral-200 p-8 hover:shadow-xl hover:border-[#FF6B35]/30 transition-all duration-300"
                  >
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-12">
                ...
                {landing.useCasesDescription ? (
                  <p className="text-lg text-[#666666] max-w-2xl mx-auto text-balance">{landing.useCasesDescription}</p>
                ) : null}
              </div>
